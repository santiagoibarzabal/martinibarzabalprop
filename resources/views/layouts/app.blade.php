...
<head>
    ...
    <!-- Icono -->
    <link rel="shortcut icon" sizes="32x32" href="{{asset('img/logo.png')}}" type="image/x-icon" alt="Martin Ibarzabal Servicios Inmobiliarios">
...
<body>
    ...
    <script>
        ...
        fbq('init', '2996575880449489');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2996575880449489&ev=PageView&noscript=1"/></noscript>
